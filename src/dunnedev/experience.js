    ...
    return (
        <Container id='experience' style={{ marginTop: "1em" }}>
            <Row>
                ...
                <Col md>
                    <DunnedevExperienceCell num="01/" jobTitle="Software Engineer" company="Stripe" start="February 2024" end="Present" startMonth={1} startYear={2024} endMonth={-1} endYear={-1}/>
